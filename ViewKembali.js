...
class ViewKembali extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {
            id_kembali: this.props.navigation.state.params.id_kembali,
            tgl_kembali_akhir: '',
            id_pinjam: '',
            nama_pegawai: '',
            tgl_kembali: '',
    ...
    _getdata() {
        ...
        axios.get('https://dre1091.000webhostapp.com/Apiuas/getKembaliWith.php?id_kembali='
            + this.state.id_kembali)
            .then(res => {
                const data = res.data;
                console.log(data);
                this.setState({ data }, () => {
                    ...
                    try {
                        this.setState({ id_kembali: Jsonval.myval[0].id_kembali });
                        this.setState({ tgl_kembali_akhir: Jsonval.myval[0].tgl_kembali_akhir });
                        this.setState({ id_pinjam: Jsonval.myval[0].id_pinjam });
                        this.setState({ denda: Jsonval.myval[0].denda });
                        this.setState({ terlambat: Jsonval.myval[0].terlambat });
    ...
    _hapus = () => {
        axios.post('https://dre1091.000webhostapp.com/Apiuas/hapusKembali.php?id_Kembali='
            + this.state.id_Kembali
        )
                ...
                <View style={styles.vMain}>
                    ...
                    <View style={styles.judul}>
                        <View style={styles.txtHeader}>
                            <Text style={styles.txtHeader}> Detail Peminjaman {this.state.id_Kembali} </Text>
                        </View>
                    </View>
                    <ScrollView>
                        <View style={styles.vBody}>
                            <View style={styles.box1}>
                                ...
                                <Text>{this.state.id_Kembali}</Text>
                            </View>
